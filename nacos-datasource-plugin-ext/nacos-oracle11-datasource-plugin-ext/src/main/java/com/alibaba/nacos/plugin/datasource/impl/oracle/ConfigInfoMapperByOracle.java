...
import com.alibaba.nacos.plugin.datasource.dialect.OracleDatabaseDialect;
...
public class ConfigInfoMapperByOracle extends AbstractOracleMapper
	...
	public MapperResult findConfigInfoByAppFetchRows(MapperContext context) {
		...
		String sql = getDatabaseDialect().getLimitPageSqlWithOffset(sqlBuilder.toString(), startRow, pageSize);
		return new MapperResult(sql, sqlArgs);
	}
	...
	public MapperResult findAllConfigKey(MapperContext context) {
		...
		String innerSql = getDatabaseDialect().getLimitPageSqlWithOffset(innerSqlBuilder.toString(), startRow,
				pageSize);
	...
	public MapperResult findChangeConfigFetchRows(MapperContext context) {
		...
		String originSql = sqlFetchRows + where + " AND id > " + lastMaxId
				+ " ORDER BY id ASC";
		String sql = getDatabaseDialect().getLimitPageSqlWithOffset(originSql, 0, pageSize);
	...
	public MapperResult findConfigInfoBaseLikeFetchRows(MapperContext context) {
		...
		int startRow = context.getStartRow();
		int pageSize = context.getPageSize();
		String sql = getDatabaseDialect().getLimitPageSqlWithOffset(sqlFetchRows + where, startRow, pageSize);
		return new MapperResult(sql, paramList);
	}
	...
	public MapperResult findConfigInfo4PageFetchRows(MapperContext context) {
		...
		int startRow = context.getStartRow();
		int pageSize = context.getPageSize();
		String resultSql = getDatabaseDialect().getLimitPageSqlWithOffset(sql + where, startRow, pageSize);
	...
	public MapperResult findConfigInfoBaseByGroupFetchRows(MapperContext context) {
		...
		String resultSql = getDatabaseDialect().getLimitPageSqlWithOffset(sql, startRow, pageSize);
...
//
		String innerSql = getDatabaseDialect().getLimitPageSqlWithOffset(sqlBuilder.toString(), context.getStartRow(), context.getPageSize());
