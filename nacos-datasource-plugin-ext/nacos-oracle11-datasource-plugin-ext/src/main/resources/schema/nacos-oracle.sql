...
-- ----------------------------
CREATE UNIQUE INDEX uk_configinfoaggr_dgtd ON config_info_aggr (data_id,group_id,tenant_id,datum_id);
...
-- ----------------------------
CREATE UNIQUE INDEX uk_configinfobeta_dgt ON config_info_beta (data_id,group_id,tenant_id);
...
-- ----------------------------
CREATE UNIQUE INDEX uk_confinfotag_dgtt ON config_info_tag (data_id,group_id,tenant_id,tag_id);
...
CREATE UNIQUE INDEX uk_configtagrelation_itt ON config_tags_relation (
  id,
  tag_name,
  tag_type
);
